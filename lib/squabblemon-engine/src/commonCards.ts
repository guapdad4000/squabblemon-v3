...
const definitions = [
  ...
  ['honestthot', 'honest-thot', 'Honest Thot', 'Air', 1, 2, 'Air Bond', 'Ongoing: While Honest Thot is in your hand, your other Air characters gain +1 Hand at round end.', 'Sustain'],
  ['earthy', 'earthy-sugar-foot', 'Earthy Sugar Foot', 'Plant', 1, 1, 'Grounded', 'Give your lowest-Hands other card here +1 Hands.', 'Support'],
  ['abuela', 'abuela', 'Abuela', 'Light', 4, 4, 'Light Bond', 'Ongoing: While Abuela is in your hand, your other Light characters gain +1 Hand at round end.', 'Sustain'],
  ['icecream', 'ice-cream-truck', 'Ice Cream Truck', 'Water', 3, 2, 'Water Bond', 'Ongoing: While Ice Cream Truck is in your hand, your other Water characters gain +1 Hand at round end.', 'Sustain'],
] as const;

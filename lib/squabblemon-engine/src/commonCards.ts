...
const definitions = [
  ...
  ['honestthot', 'honest-thot', 'Honest Thot', 'Air', 2, 1, 'Air Bond', 'Ongoing: While Honest Thot is in your hand, your other Air characters gain +1 Hand at round end.', 'Sustain', 'Air'],

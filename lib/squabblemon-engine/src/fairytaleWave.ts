...
export const FAIRYTALE_WAVE = [
  ...
  ['sherlock', 'sherlock', 'Sherlock', 'Epic', 'Light', 3, 4, 'Stakeout', 'On Reveal: Set a visible trap in the strongest other enemy district. It cancels the next enemy entrance ability there, then disappears; if it cancels, Sherlock gains +2 Hands. Expires after next round.', 'Disruption'],
  ['watson', 'watson', 'Watson', 'Rare', 'Water', 2, 2, 'Still Breathing', 'On Reveal: Restore up to 3 Hands actually lost to damage to your weakest injured ally here and Protect it; otherwise Protect your weakest other ally here. Also Protect a friendly Sherlock anywhere.', 'Sustain'],

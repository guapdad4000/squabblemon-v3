...
export const FAIRYTALE_WAVE = [
  ['dorothy', 'dorothy', 'Dorothy', 'Epic', 'Air', 3, 3, 'No Place Like Home', 'On Reveal: Return your weakest other character here with a printed cost of 2 or less to your hand. Its next deployment costs 1 less Motion, minimum 1.', 'Movement'],
  ['scarecrow', 'scarecrow', 'Scarecrow', 'Rare', 'Earth', 2, 2, 'Wrong Turn, Right Place', 'On Reveal: Swap districts with your weakest ally in another open district. If both can move, both gain +1 Hand.', 'Movement'],
  ['tinman', 'tin-man', 'Tin Man', 'Rare', 'Electric', 2, 2, 'Heart Starter', 'Ongoing: The first other ally entering your district each round gains Protection. Playing or moving an ally here qualifies.', 'Support'],
  ...
  ['oz', 'oz', 'Oz', 'Mythical', 'Light', 4, 3, 'The Grand Reveal', 'On Reveal: Once per match, repeat the entrance ability of your last ally that moved this round, at its current district. Cannot repeat ability-copying effects.', 'Support'],
  ['alice', 'alice', 'Alice', 'Rare', 'Water', 2, 2, 'Drink Me / Eat Me', 'Ongoing: At round end, return to your hand once per match, except during the final round. Your next deployment gains +3 Hands.', 'Movement'],
  ['cheshire', 'cheshire', 'Cheshire', 'Epic', 'Air', 3, 3, 'The Smile Stays', 'Ongoing: The first ally returned to your hand each round leaves a 2-Hand Grin in its district. Maximum one friendly Grin per district.', 'Support'],
  ['queenofhearts', 'queen-of-hearts', 'Queen of Hearts', 'Legendary', 'Dark', 4, 3, 'Off With Their Heads', 'On Reveal: Execute the weakest enemy here if it has 3 or fewer Hands. A successful execution summons a 2-Hand Card Guard. Protection can block execution.', 'Disruption'],
  ['sherlock', 'sherlock', 'Sherlock', 'Epic', 'Light', 3, 3, 'Stakeout', 'On Reveal: Set a visible trap in the strongest other enemy district. It cancels the next enemy entrance ability there, then disappears. Expires after next round.', 'Disruption'],
  ['watson', 'watson', 'Watson', 'Rare', 'Water', 2, 2, 'Still Breathing', 'On Reveal: Restore up to 2 Hands actually lost to damage to your weakest injured ally here. If any Hands are restored, grant Protection.', 'Sustain'],
  ...
  ['ronald', 'revolutionary-ronald', 'Revolutionary Ronald', 'Epic', 'Earth', 3, 3, 'Organize', 'Ongoing: Once per round, when an enemy damages another ally here, give your weakest ally in each other district +1 Hand.', 'Comeback'],

...
const upgradeEffects: Record<string, readonly AbilityUpgradeEffect[]> = {
  buddy: Array.from({ length: 3 }, () => ({ kind: "self-power" as const, amount: 1 as const, trigger: "base-success" as const })),
...
export const cards: Record<string, Card> = {
  buddy: { id: "buddy", name: "BUDDY", kind: "character", type: "Earth", cost: 3, power: 4, ability: "Buddy Buds", effect: "Normal form: cards played in BUDDY's district cost 1 less Motion (minimum 0). After two rounds, BUDDY gains +3 Hands and planted Buddy Buds sprout. On reveal, plant Buds in two or three randomly chosen eligible districts; when each Bud sprouts, it gives +3 Hands to the last eligible friendly character already in its district. Full districts are skipped; Buds that sprout with no eligible friendly recipient remain harmless and give no Hands. Buds planted too late to sprout before match end are not placed.", roles: ["Growth", "Support"], abilityUpgrades: upgrades("buddy", [["Strong Roots", "BUDDY's Buds draw strength into their roots.", "Earthbound", "BUDDY's Buds anchor BUDDY more firmly.", "Deep Roots", "BUDDY's growth keeps drawing strength."]]), entryVfx: { accent: "#74a84a" }, portraitAccent: "#74a84a" },
  ...
  rastamon: { id: "rastamon", name: "Rastamon", type: "Plant", cost: 2, power: 2, ability: "Natural Cure", effect: "Cleanse a frozen or silenced ally here and give it +2 Hands. If none needs cleansing, give your weakest other ally here +1 Hand.", abilityUpgrades: upgrades("rastamon", [["Rooted Remedy", "Natural Cure grants +1 Hands to Rastamon.", "Herbal Guard", "Natural Cure grants +1 Hands to Rastamon.", "Evergreen", "Natural Cure grants +1 Hands to Rastamon."]]), entryVfx: { accent: "#4ade80", keyframeId: "vine-burst" }, portraitAccent: "#4ade80", immersiveAssetId: { backgroundAssetId: "assets/cards/immersive/rastamon/bg.webp", foregroundAssetId: "assets/cards/immersive/rastamon/fg.webp" } },
  ...
  gamer: { id: "gamer", name: "Gamer", type: "Dark", cost: 3, power: 3, ability: "City Tour", effect: "On Reveal: Give your lowest-Hands ally in each other district +1 Hand. Ongoing: While on board, the first time each round you newly Silence or Weaken an enemy, your lowest-Hands Dark ally gains +2 Hands.", abilityUpgrades: upgrades("gamer", [["Warmup", "City Tour grants +1 Hands to Gamer.", "Ranked Focus", "City Tour grants +1 Hands to Gamer.", "Clutch Mode", "City Tour grants +1 Hands to Gamer."]]) },
  ...
  bottle: { id: "bottle-girl", name: "Bottle Girl", type: "Poison", cost: 2, power: 3, ability: "Last Call", effect: "On Reveal: If played on Round 4 or later, gain +2 Hands. Your next Poison character costs 1 less Motion, minimum 1, through the next round.", abilityUpgrades: upgrades("bottle", [["After Hours", "Last Call grants +1 Hands to Bottle Girl.", "VIP Section", "Last Call grants +1 Hands to Bottle Girl.", "Closing Time", "Last Call grants +1 Hands to Bottle Girl."]]) },
  ...
  landlord: { id: "landlord", name: "Landlord", type: "Earth", cost: 2, power: 3, ability: "Rent Due", effect: "Ongoing: The first enemy card played at this district each round costs 1 additional Motion. When that tax is actually paid, Landlord gains +1 Hands once per round.", roles: ["Disruption"], abilityUpgrades: upgrades("landlord", [["Late Fee", "Rent Due grants +1 Hands to Landlord.", "Lease Renewal", "Rent Due grants +1 Hands to Landlord.", "Keyholder", "Rent Due grants +1 Hands to Landlord."]]), entryVfx: { accent: "#d4a373" }, portraitAccent: "#d4a373" },
  ...
  promoter: { id: "promoter", name: "Promoter", type: "Air", cost: 3, power: 3, ability: "Guest List", effect: "On Reveal: Reveal one enemy hand card. If it costs 4+, your next card in another district costs 1 less Motion. Ongoing: While on board, the first Air ally, Bottle Girl, Pirate Radio DJ, or Dance Captain to move each round gains +2 Hands (one shared trigger).", abilityUpgrades: upgrades("promoter", [["Plus One", "Guest List grants +1 Hands to Promoter.", "Wristband", "Guest List grants +1 Hands to Promoter.", "Headliner", "Guest List grants +1 Hands to Promoter."]]) },

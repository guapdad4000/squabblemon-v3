...
export const cards: Record<string, Card> = {
  ...
  plug: { id: "plug", name: "Plug", type: "Electric", cost: 2, power: 2, ability: "Connections", effect: "Your next card in another district costs 1 less Motion." },
  ...
  techbro: { id: "techbro-rich", name: "Techbro Rich", type: "Electric", cost: 4, power: 4, ability: "VC Funded Flex", effect: "Spend 1 unspent Motion to gain +2 Power." },

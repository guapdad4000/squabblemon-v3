...
export function rookieEncounter(): StoryEncounterSnapshot {
  return {
    ...
    enemy: { id: 'fade-training', name: 'Dr. Fade’s training crew', portraitAssetId: 'assets/tutorial/dr-fade-welcome.png', deckId: 'vibes', cardIds: ['cornball', 'plug', 'hooper', 'rastamon', 'earthy', 'church', 'nail', 'landlord', 'og', 'wifey'], behaviorProfile: 'support' },

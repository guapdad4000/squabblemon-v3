...
export const blockPartyChapter: StoryChapter = {
  ...
  nodes: [
    ...
    { id: "block-crowned", kind: "reward", title: "Block Crowned", mapPosition: { x: 94, y: 5 }, prerequisites: ["cracked-head-takes-the-block"], optional: false, rewards: [{ kind: "card", id: "nerd", amount: 1 }, { kind: "pack-ticket", id: "street-pack-ticket", amount: TICKETS_PER_MAJOR_STORY_NODE }, { kind: "cosmetic", id: "block-party-crowned", amount: 1 }, { kind: "chapter-key", id: "story-key:chapter-two", amount: 1 }, { kind: "currency", id: "clout", amount: 250, claimKey: "dr-fade-training:chapter-one:v1" }], teaching: teaching(["Chapter Two is unlocked after this ceremony.", "Major story finales award Street Pack tickets.", "Use your 250 Clout training fund at the Trading Post: Practice Session adds character XP; Move Coaching unlocks Corner Advice at level 2."], ["collection rewards"], ["nerd"]), cinematic: cinematic("cracked-head-finale", "victory"), scenes: [line("Snitch", portraits.snitch, "Block Crowned. Your Chapter Two route is open."), line("Dr. Fade", "assets/characters/dr-fade.webp", "You earned that. Take 250 Clout for training. Get me to level 2, then grab Corner Advice from Move Coaching at the Trading Post. We keep getting stronger together.") ] },
  ],
};

...
export const MYTHIC_LEGENDS = [
  ...
  ["captainjigga","captain-jigga","Captain Jigga","Air",5,4,"Cabin Gang","Send two 2-Hand Steward tokens. Each targets a different highest-Hands enemy for -1 Hand.","Disruption"],

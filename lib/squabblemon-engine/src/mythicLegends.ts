...
export const MYTHIC_LEGENDS = [
  ...
  ['johnhenry', 'john-henry', 'John Henry', 'Earth', 5, 5, 'Steel Driver', 'Gain +1 Hands for each other friendly character here, up to +3. If at least two are here, give the highest-Hands enemy -1 Hands.', 'Pressure'],

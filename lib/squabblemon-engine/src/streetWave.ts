...
export const STREET_WAVE = [
  ...
  ['incel', 'incel', 'Incel', 'Common', 'Dark', 2, 3, 'Dark Bond', 'Ongoing: While Incel is in your hand, your other Dark characters gain +1 Hand at round end.', 'Sustain'],
  ['redpill', 'red-pill', 'Red Pill', 'Epic', 'Dark', 3, 3, 'Echo Chamber', 'On Reveal: Apply Weaken to the highest-Hands enemy here. If already Weakened, Silence them and gain +2 Hands instead.', 'Disruption'],

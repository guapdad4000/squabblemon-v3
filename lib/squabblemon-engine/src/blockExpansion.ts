...
export const BLOCK_EXPANSION = [
  ...
  ['mural', 'mural-apprentice', 'Mural Apprentice', 'Common', 'Poison', 2, 2, 'Fresh Color', 'On Reveal: If another friendly card with a different type is here, apply Lock to the highest-Hands enemy here. Otherwise gain +1 Hands.', 'Disruption'],
  ...
  ['gardener', 'rooftop-gardener', 'Rooftop Gardener', 'Common', 'Plant', 1, 1, 'Plant Bond', 'Ongoing: While Rooftop Gardener is in your hand, your other Plant characters gain +1 Hand at round end.', 'Tempo'],
  ['piratedj', 'pirate-radio-dj', 'Pirate Radio DJ', 'Rare', 'Electric', 3, 2, 'Citywide Signal', 'On Reveal: Give your lowest-Hands friendly card in each other district +1 Hand. Ongoing: While Pirate Radio DJ is in your hand, your other Electric characters gain +1 Hand at round end.', 'Support'],

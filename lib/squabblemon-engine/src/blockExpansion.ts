...
export const BLOCK_EXPANSION = [
  ...
  ['piratedj', 'pirate-radio-dj', 'Pirate Radio DJ', 'Epic', 'Electric', 3, 2, 'Citywide Signal', 'On Reveal: Give your lowest-Hands friendly card in each other district +1 Hand. Ongoing: While Pirate Radio DJ is in your hand, your other Electric characters gain +1 Hand at round end.', 'Support', 'Electric'],

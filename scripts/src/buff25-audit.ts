...
const baselineCommit = "7b886054ca42d7c89e67cb21e19397353c8da95b";
...
for (const subject of subjects) {
  ...
  for (const districtSeed of [
    "creative-wave-20260925",
    "buff25-side-streets-20260926",
  ])
...
const out = path.join(root, "scripts/results/buff25");
...
writeFileSync(
  ...
  JSON.stringify({
    ...
    seeds: ["creative-wave-20260925", "buff25-side-streets-20260926"],
    subjects,
    foes,
    results,
  }),

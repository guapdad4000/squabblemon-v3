...
export const getAssetUrl = (path: string) => {
  if (path === 'assets/e71f5189-861e-418d-8237-fa20713b9122.png') {
    return '/__mockup/images/battle-current/battlefield.png';
  }
  return `/__mockup/images/battle-current/${path.replace(/^assets\/characters\//, '').replace(/^assets\//, '')}`;
};

export const getCardImage = (id: string) =>
  `/__mockup/images/battle-current/${id}.webp`;

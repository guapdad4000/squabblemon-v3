...
const batching=batchStaticMeshes(scene,[tv,bagPivot,cards,phone,roomDetails.vinyl,...roomDetails.dynamicObjects]);
...
const raycaster=new T.Raycaster(),pointer=new T.Vector2();const interactive=[{object:tv,key:'story'},{object:bag,key:'training'},{object:cards,key:'cards'},{object:phone,key:'phone'},{object:roomDetails.vinyl,key:'music'}];

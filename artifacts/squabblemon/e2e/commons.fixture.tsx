...
createRoot(document.getElementById('root')!).render(<main style={{ background: '#171918', padding: 24, minHeight: '100vh', color: 'white' }}>
  <h1 style={{ fontSize: 28, marginBottom: 20 }}>Around the Block · 11 Commons</h1>
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))', gap: 20 }}>
    {cardCatalog.filter(card => card.faction === 'Around the Block').map(card => <div key={card.id}>

  ...
  return <div className="how-to-play">
    ...
    <main>
      ...
      <section className="guide-section guide-loop" id="the-loop" aria-labelledby="loop-heading">
        ...
        <div className="guide-inline-note"><Check size={19} /><p><strong>Start with a real gang.</strong> Rookie Road gives you a {ROOKIE_FOUNDATION_IDS.length}-card foundation. You can learn the game before chasing the rest of the collection.</p></div>
      </section>
      ...
      <section className="guide-section guide-battle" id="the-battle" aria-labelledby="battle-heading">
        <div className="guide-section-intro"><SectionTitle number="03" label="Playing a fade"><span id="battle-heading">Win the districts.<br /><em>Win the argument.</em></span></SectionTitle><p>At the end of round six, you need more Hands in at least two districts. A giant stack in one district still wins only one district.</p></div>

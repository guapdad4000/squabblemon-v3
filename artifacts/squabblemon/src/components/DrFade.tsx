...
export const DR_FADE_LESSONS = [
  ...
  { title: 'Read before you commit.', text: 'A card’s ability and its district can change the fight. Check the highlighted district and the rival’s tell. Save your once-per-fade Squabble for a moment that matters.' },

...
export function RulesModal({ onClose }: any) {
  const rules = [
    ...
    "SQUABBLE can be armed once per match after selecting a card. It doubles that card's Base Hands: save it to steal a close district or force the rival to answer, but do not wait past round six."
  ];

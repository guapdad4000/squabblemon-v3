...
export function Battle({
  ...
  const drag = useBattleDrag({
    enabled: interactive && Boolean(onPlayCard) && tutorialCardPlayAllowed, contextKey: `${m.round}:${m.nextEventSequence}:${phase}`,

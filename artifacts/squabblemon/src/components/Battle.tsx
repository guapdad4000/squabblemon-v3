...
export function Battle({
  ...
  return <div data-testid="battle-arena" data-presentation-phase={phase} data-reduced-motion={reducedMotion ? 'true' : 'false'} className={`battle-arena phase-${phase} flex flex-col h-full w-full max-w-full mx-auto overflow-hidden relative z-10 bg-[#0d0d0d]`} aria-label={`Battle phase: ${phaseMessage}`}>
